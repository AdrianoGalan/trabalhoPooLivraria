...
public class TelaControleRelatorio implements ControleTelas, EventHandler<ActionEvent> {
	...
	/**
	 * M�todo handle - acao aos botoes - exibir relatorio
	 */
	@Override
	...
	/**
	 * M�todo que pega livros com estoque baixo - menor que 5.
	 */
	...
	/**
	 * m�todo que carrega os livros mais e menos vendidos
	 */
	...
	/**
	 * M�todo que carrega o melhor dia da semana para venda de livros
	 */
