...
public class TelaCadastroFuncionario implements ControleTelas, EventHandler<ActionEvent> {
	...
	/**
	 * M�todo que adiciona dados do funcionario
	 */
	...
	/**
	 * M�todo que verifica se os campos foram preenchidos corretamente.
	 * 
	...
	/**
	 * M�todo que carrega os dados do funcionario
	 * 
	 * @param f
	 */
	...
	/**
	 * M�todo que verifica se tem dados duplicados. 
	 * @return true or false
	 */
